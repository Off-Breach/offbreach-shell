...
sudo docker build -t offbreach-1.0-SNAPSHOT-jar-with-dependencies.jar:1.0 .
sudo docker run -d -p 3306:3306 --name offbreach -e offbreach-1.0-SNAPSHOT-jar-with-dependencies.jar:1.0 
